...
<!--  
 <form action="Login" method="GET">
 	User Name : <input type="text" name="uname" placeholder="user name"/></br></br>
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
		  ...
		  <!-- the below three spans are responsible for the three bars on the hamberger icon -->
            ...
            <!-- for the logo -->
	  	 	<a href="C:/Users/DELL%20PC/Documents/PROJECT/landing-page/landingpage.html" class="navbar-brand">PLAN-YOUR-TRIP</a>
...
<!-- ******************************************************************************************************************** -->
		...
		<div class="loginBox">
			...
			<input type="hidden" name="c" value="login">
				...
				<a href="Admin.jsp"  style="pull-right">Admin</a>		
